...
export class CommandeClientsService extends BaseService {
     ...
     * @param reportProgress?? flag to report request and response progress.
     */
    public findAllLignesCommandesClientByCommandeClientId(idCommande: number | undefined, observe?: "body", reportProgress?: boolean, options?: { httpHeaderAccept?: "*/*"; context?: HttpContext }): Observable<Array<LigneCommandeClientDto>>;
    ...
    /**
     * @endpoint get /gestiondestock/v1/commandeClients/{codeCommandeClient}
     * @param codeCommandeClient
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public findByCode2(codeCommandeClient: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<CommandeClientDto>;
    public findByCode2(codeCommandeClient: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpResponse<CommandeClientDto>>;
    public findByCode2(codeCommandeClient: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<HttpEvent<CommandeClientDto>>;
    public findByCode2(codeCommandeClient: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/gestiondestock/v1/commandeClients/${this.configuration.encodeParam({name: "codeCommandeClient", value: codeCommandeClient, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
        const { basePath, withCredentials } = this.configuration;
