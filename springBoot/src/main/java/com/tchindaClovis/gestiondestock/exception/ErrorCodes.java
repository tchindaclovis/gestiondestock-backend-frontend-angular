...
public enum ErrorCodes {
    ...
    UTILISATEUR_PASSWORD_INVALID(12004),

    BAD_CREDENTIALS(12005),

    UTILISATEUR_CHANGE_CATEGORY_OBJECT_NOT_VALID(12006),

    UTILISATEUR_CHANGE_FOURNISSEUR_OBJECT_NOT_VALID(12006),
